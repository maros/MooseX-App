...
If you want to use global options defined in the base class you can extend the
...
If you want to provide a description for each command to the users
...
If you do not want to include an attribute not defined with 'option'
you can use the 'AppOption' trait 
...
L<MooseX::App::Simple> instead of L<MooseX::App>, ans omit command classes.
